...
function setup() 
{
  ...
  star1 = createSprite(110,300,100,100);
  star1.scale = 0.02;
  star1.addImage(starImg)

  scoreStar = createSprite(50,50,100,100);
  scoreStar.scale = 0.2;
  scoreStar.addAnimation("none",noStar)
  scoreStar.addAnimation("one",oneStar)
  scoreStar.addAnimation("two",twoStar)
  scoreStar.changeAnimation("none")

  star2 = createSprite(290,130,100,100);
  star2.scale = 0.02;
...
function airblow(){
  Matter.Body.applyForce(fruit,{x:0,y:0},{x:0,y:-0.025})
  air.play()
}
